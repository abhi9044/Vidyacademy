...
public class Findtutor extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        findtutor=(Button)findViewById(R.id.bfindtutor);
        findtutor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Findtutor.this, SearchTests.class);
                startActivity(i);
            }
        });
        applytutor=(Button)findViewById(R.id.bapplytutor);
        applytutor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Findtutor.this, Registration.class);
                startActivity(i);
            }
        });

        reqtutor=(Button)findViewById(R.id.breqtutor);
        reqtutor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Findtutor.this, RequestTutor.class);
                startActivity(i);
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Findtutor.this, SecondActivityMain.class);
                startActivity(i);
