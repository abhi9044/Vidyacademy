...
bviewprog=(Button)findViewById(R.id.bviewprog);
        bviewprog.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(StudentProfile.this, SecondActivityMain.class);
                startActivity(i);
