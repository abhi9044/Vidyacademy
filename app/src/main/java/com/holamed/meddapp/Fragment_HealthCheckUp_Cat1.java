...
public class Fragment_HealthCheckUp_Cat1 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_health_cat1, container, false);
        final Activity parentActivity = this.getActivity();
        noResultView = (TextView) rootView.findViewById(R.id.no_resultcat1);



        dealsList = new ArrayList<DealsItem>();
        listView = (ListView) rootView.findViewById(R.id.deals_listviewnewcat1);
    ...
    static public void loadView() {
        ...
        dealsList = AppControllerSearchTests.dealsfecthedcat1;
