...
import com.holamed.meddapp.adapter.SubEventAdapter;
...
public class Registration_Events extends AppCompatActivity implements OnItemSelectedListener {
    ...
    boolean isImage;
    String signal;
    ArrayList<EventsObject> arralias = new ArrayList<EventsObject>();
    java.util.List<String> idlist;
    java.util.List<String> namelist;
    java.util.List<String> pricelist;
    private EditText ageEditText;
    private EditText line1EditText;
    SubEventAdapter adapte;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_events);
        home = (ImageView) findViewById(R.id.home_pressed);
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Registration_Events.this, SecondActivityMain.class);
                startActivity(i);
     ...
     //   lvsearch = (ListView) findViewById(R.id.list_view_subevents);
        item=AppControllerSearchTests.getSelectedEvent();

        //adapte = new SubEventAdapter(Registration_Events.this, arralias);
                  ...
                  /*  if (loggedinUser) {
                    ...
                    if (signal.equals("phar")) {
                      /*  Intent upload = new Intent(Registration.this, UploadActivity.class);
                        ...
                        Intent intent;
                        intent = new Intent(v.getContext(), Confirmation_Events.class);
                        ...
                        AppControllerSearchTests.setSubEventType("Diagnostic");
