...
public class Detailed_result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Detailed_result.this,SecondActivityMain.class);
                startActivity(i);
        ...
        selected_option=AppControllerSearchTests.getSelectedLab();
    ...
    /*    direction.setOnClickListener(new View.OnClickListener() {
        ...
        selectlab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
//                Intent i=new Intent(Detailed_result.this,Registration.class);
finish();
...
//                AppControllerSearchTests.setSearchType(AppControllerSearchTests.TYPELAB);
  //              AppControllerSearchTests.setSelectedLab(selected_option);
