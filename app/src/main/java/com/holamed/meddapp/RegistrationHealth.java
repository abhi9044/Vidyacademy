...
public class RegistrationHealth extends AppCompatActivity implements OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(RegistrationHealth.this, SecondActivityMain.class);
                startActivity(i);
                ...
                if (NameEditText.getText().toString().length() == 0) {
                    ...
                    if (signal.equals("phar")) {
                      /*  Intent upload = new Intent(Registration.this, UploadActivity.class);
                        ...
                        Intent intent;
                        intent = new Intent(v.getContext(), ConfirmationHealth.class);
