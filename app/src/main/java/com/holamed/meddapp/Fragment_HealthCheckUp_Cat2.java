...
public class Fragment_HealthCheckUp_Cat2 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_health_cat2, container, false);
        final Activity parentActivity = this.getActivity();
        noResultView = (TextView) rootView.findViewById(R.id.no_resultcat2);


        dealsList = new ArrayList<DealsItem>();
        listView = (ListView) rootView.findViewById(R.id.deals_listviewnewcat2);
    ...
    static public void loadView() {
        dealsList = AppControllerSearchTests.dealsfecthedcat2;
