...
public class Detailed_result_patho extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Detailed_result_patho.this,SecondActivityMain.class);
                startActivity(i);
        ...
        selected_option=AppControllerSearchTests.getSelectedLabPatho();
    ...
    /*    direction.setOnClickListener(new View.OnClickListener() {
        ...
        selectlab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    //            Intent i=new Intent(Detailed_result_patho.this,Registration.class);
                finish();
...
//                AppControllerSearchTests.setSearchType(AppControllerSearchTests.TYPELAB);
  //              AppControllerSearchTests.setSelectedLabPatho(selected_option);
