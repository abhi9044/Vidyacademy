    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Confirmation.this, SecondActivityMain.class);
                startActivity(i);
        ...
        if (AppControllerSearchTests.getSearchType().equals(AppControllerSearchTests.TYPELAB)) {
            if (result.equals("nohealth")) {
                selectedLab = AppControllerSearchTests.getSelectedLab();
...
*/
  ...
  //          a.setDateString(sdf.format(date));
   ...
   /* private void RegisterPerson() throws JSONException {
        ...
        String para;
        if (result.equals("nohealth")) {
            if (AppControllerSearchTests.getPatientAddressline1().length() > 0)
                homeCollection = true;
...
*/
    ...
    void getCode() throws JSONException {
        ...
        //make transaction to get coupon code
           ...
           userID=loginPrefs.getString("UserId","null");
           // userID = "5667c8f55eb25ae64bd834f0";//for now
            userMail = patientEmail;//for now

            patientFull = new JSONObject();
            if(AppControllerSearchTests.getPatientId()!=null)
...
*/
                ...
                Log.d("aadress",String.valueOf(patientAddress));
                if (homeCollection) {
                    Log.d("address in",String.valueOf(patientAddress));
                ...
                if (result.equals("nohealth")) {
                    ...
                    testObj.put("_id", "Health Package");
                    testObj.put("name", "Health Package");
                    testObjArray.put(testObj);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (response.getBoolean("status")) {
                            ...
                            */ResultItem alpha = AppControllerSearchTests.getSelectedLab();
